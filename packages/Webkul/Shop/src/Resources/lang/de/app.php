...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Copyright 2025 - :current_year, Delaleu Systems (in Rumänien registriert). Alle Rechte vorbehalten.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text' => '© Copyright 2025 - :current_year, Delaleu Systems (eingetragen in Rumänien). Alle Rechte vorbehalten.',
                'locale' => 'Sprache',
